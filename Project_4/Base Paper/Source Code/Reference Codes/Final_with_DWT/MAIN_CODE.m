...
[latest_data,L,M]=lsbhide(pic_data,M,L);

[ll1,hl1,lh1,hh1]=dwt2(latest_data,'db1');
a=[ll1,hl1;lh1,hh1];
figure,imshow(a,[]);
...
b1=idwt2(ll2,hl2,lh2,hh2,'db1');
figure,imshow(b1,[]);
title('2-level  image');
a1=idwt2(b1,hl1,lh1,hh1,'db1');
 figure,imshow(a1,[]);
 title('Hidden image');

imwrite(latest_data,'hidden1.bmp','bmp');
